...
[empiricalMeans, rewardlist] = banditProblem.epsilonGreedyBandit(nIterations=400)
...
# Test REINFORCE
policy, _ = rlProblem.reinforce(s0=0, initialPolicyParams=np.random.rand(mdp.nActions, mdp.nStates), nEpisodes=1000,
                             nSteps=100)
print("\nREINFORCE results")
print(policy)
